...
tokenJoin = '1276023652:AAFLGVKFXCfaMaycxzr_je1ExrBItxmXYcA'
...
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
local info = redis:hgetall(max..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
function bass(msg) 
local message = '*⋆⇽قائمه المتوحدين *\n\n'
local monsha = redis:smembers(max..':bba:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function kll(msg) 
local message = '*⋆⇽قائمه المزز *\n\n'
local monsha = redis:smembers(max..':kww:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function trrr(msg) 
local message = '*⋆⇽قائمه الذبان *\n\n'
local monsha = redis:smembers(max..':tta:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function kakaa(msg) 
local message = '*⋆⇽قائمه الكيك *\n\n'
local monsha = redis:smembers(max..':kaka:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function ssee(msg) 
local message = '*⋆⇽قائمه الخولات *\n\n'
local monsha = redis:smembers(max..':ssee:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function klaa(msg) 
local message = '*⋆⇽قائمه الكلاب *\n\n'
local monsha = redis:smembers(max..':kka:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function yyoo(msg) 
local message = '*⋆⇽قائمه العرر *\n\n'
local monsha = redis:smembers(max..':yoo:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function ggoo(msg) 
local message = '*⋆⇽قائمه البقر *\n\n'
local monsha = redis:smembers(max..':baa:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function aahh(msg) 
local message = '*⋆⇽قائمه القرود *\n\n'
local monsha = redis:smembers(max..':ggyy:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function hhaa(msg) 
local message = '*⋆⇽قائمه الحمير *\n\n'
local monsha = redis:smembers(max..':mote:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function zzkk(msg) 
local message = '*⋆⇽قائمه الوتكات *\n\n'
local monsha = redis:smembers(max..':zmm:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
function zzzkkk(msg) 
local message = '*⋆⇽قائمه الخرا *\n\n'
local monsha = redis:smembers(max..':zzkm:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."⋆⇽ مفيش حد مرفوع في البوت\n❕"
else
for k,v in pairs(monsha) do
...
return sendMsg(msg.chat_id_,msg.id_,"⋆⇽تم رفع  { *"..NumAdmin.."* } مـن الادمنيه في آلبوت ")
end
end,100)
end
...
if not msg.SudoUser and not service then return '⋆ ⇽انت لست مطوري ' end
...
if redis:get(max..'group:add'..msg.chat_id_) then  return '⋆ *⇽*المجموعه  بالتأكيد تم تفعيلها' end
...
return "⋆ ⇽اشترك بالقناه ["..UserChaneel.."] \n⋆⇽ثم ارسل تفعيل ."
end
else
return "⋆ ⇽اشترك بالقناه ["..UserChaneel.."] \n⋆⇽ثم آرجع آرسـل تفعيل ."
end
...
return sendMsg(msg.chat_id_,msg.id_,'⋆ *⇽*لا يمكن تفعيل البوت في المجموعات الاقل من  *【'..GroupUsers..'】* عضـو ⋆')
else 
GetChatMember(msg.chat_id_,our_id,function(arg,data)
if data.status_.ID == "ChatMemberStatusMember" then
return sendMsg(msg.chat_id_,msg.id_,'⋆*⇽*عذرا البوت ليس مشرف في المجموعة \n⋆*⇽*ارفع البوت مشرف للتمكن من تفعيله')
else
local lock_service = redis:get(max..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'•* تم تفعيل المجموعه بنجاح .  𖠭 . \n*• ورفع كل المشرفين\n [𝐒𝐎𝐔𝐑𝐄𝐂𝐄 𝐌𝐄𝐆𝐀 𝐓𝐑𝐎𝐍](https://t.me/SOURECE_MEGA_TRON)')
else
...
function modrem(msg)
if not msg.SudoUser then return '*⇽*مش معاك مطور عشان تعطلها 'end
if not redis:get(max..'group:add'..msg.chat_id_) then return '*⇽* المجموعه اتعطلت اذا اردت مميزاتي مره اخري اكتب تفعيل' end  
rem_data_group(msg.chat_id_)
return '⋆*⇽* تم تعطيل المجموعه بنجاح يا مطوري '
end
...
if cmd == "voo" then
if UserID == our_id then 
return sendMsg(ChatID,MsgID,"⋆*⇽*عذرا لايمكن رفع نفسي \n") 
...
if redis:sismember(max..':kaka:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد كيكه \n✓️',17,USERCAR) 
end
redis:sadd(max..':kaka:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح كيكه \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':zahaf:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد رفع خول\n✓️',17,USERCAR) 
end
redis:sadd(max..':zahaf:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح خول\n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':kka:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد كلب\n✓️',17,USERCAR) 
end
redis:sadd(max..':kka:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصيح كلب\n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':yoo:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد عره \n✓️',17,USERCAR) 
end
redis:sadd(max..':yoo:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح عره \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':baa:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد بقرة \n✓️',17,USERCAR) 
end
redis:sadd(max..':baa:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح بقرة \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':ggyy:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد قرد \n✓️',17,USERCAR) 
end
redis:sadd(max..':ggyy:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح قرد \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':mote:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد حمار\n✓️',17,USERCAR) 
end
redis:sadd(max..':mote:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح حمار \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':zmm:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد وتكه \n✓️',17,USERCAR) 
end
redis:sadd(max..':zmm:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح وتكه \n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':bba:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد متوحده\n✓️',17,USERCAR) 
end
redis:sadd(max..':bba:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح متوحده\n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':tta:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد ذبانه\n✓️',17,USERCAR) 
end
redis:sadd(max..':tta:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح ذبانه\n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':kww:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد مزه\n✓️',17,USERCAR) 
end
redis:sadd(max..':kww:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح مزه\n✓️',17,USERCAR) 
end
...
if redis:sismember(max..':zzkm:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽انه بالتأكيد خرا \n✓️',17,USERCAR) 
end
redis:sadd(max..':zzkm:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆⇽العضو » ❪ '..USERNAME..' ❫\n⋆⇽الايدي » ❪ '..UserID..' ❫\n⋆⇽تمت ترقيته ليصبح خرا \n✓️',17,USERCAR) 
end
...
elseif  UserID == 1560460212 then 
return sendMsg(ChatID,MsgID,"⋆ *⇽*لا يمكنني تقيد او كتم او حظر مطور السورس\n") 
elseif UserID == SUDO_ID then 
